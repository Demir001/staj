...
LINUX_AUTH_LOG_PATH = "logs/auth.log"   # Güvenlik ve kimlik doğrulama logu yolu

# 3. Oturum ve Eylemsizlik Zaman Aşımı (Auto-Kick)
IDLE_SESSION_TIMEOUT_SECONDS = 900      # 15 Dakika (900 saniye) eylemsiz oturumları otomatik kapatma

# 4. Güvenlik Riski ve Kayan Zaman Penceresi
...
# 5. Ağ Yapılandırması (İç Ağ vs. Dış Ağ)
INTERNAL_SUBNETS = [
...
# 6. İnsani Yazım Hatası (Typo) Tolerans Eşikleri
...
# 7. Kritiklik Düzeyine Göre Kademeli Ban Süreleri (Saniye Cinsinden)
